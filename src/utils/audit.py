...
def log_admin_action(
    admin: str, action: str, details: str, request: Optional[Request] = None
) -> None:
    """
    ...
    try:
        ...
        if result.data:
            ...
            logger.warning(
                f"Failed to log admin action: {action} by {admin} - no data returned"
            )
...
def log_admin_action_auto(
    action: str, details: str, request_obj: Optional[Request] = None
) -> None:
    """
